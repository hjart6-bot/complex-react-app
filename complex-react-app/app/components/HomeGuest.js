...
function HomeGuest() {
  ...
  async function handleSubmit(e) {
    e.preventDefault()
    try {
      //Axios is a library for sending requests
      //If code runs into problem catch will run
      await Axios.post("/register", { username, email, password }) //when value is prop name we can just use that
